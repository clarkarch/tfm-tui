...
export const registerSyntaxParsers = (): void => { addDefaultParsers(EXTRA_PARSERS); };
...
export const syntaxStyleSig = (t: Theme): string =>
  [t.accent, t.white, t.sidebarFg, t.sidebarFgMuted,
    t.syntaxString, t.syntaxNumber, t.syntaxType, t.syntaxFunction, t.syntaxOperator, t.syntaxProperty].join("|");

export const buildSyntaxStyle = (t: Theme) => SyntaxStyle.fromStyles({
